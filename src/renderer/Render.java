...
public class Render {
    ...
    /**
     * @param flagDOF
     * @return the flag of DOF
     */
    public Render setFlagDOF(boolean flagDOF) {
        this.flagDOF = flagDOF;
        return this;
    }
    ...
    private void castRays(int nX, int nY, int col, int row) {
        List<Ray> rayList = camera.constructRaysThroughPixel(nX, nY, col, row);
        Color temp = tracer.traceRays(rayList);
        imageWriter.writePixel(col, row, temp);
    }
