...
public class ShadowTests {
    ...
    public void sphereTriangleInitial2() {
        ...
        scene.lights.add( //
                new SpotLight(new Color(400, 240, 0), new Point3D(-100, -70, 130), new Vector(1, 1, -3)) //
                        .setKl(1E-5).setKq(1.5E-7));
    ...
    public void sphereTriangleInitial3() {
        scene.geometries.add( //
                new Sphere(60, new Point3D(0, 0, -200)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
                new Triangle(new Point3D(-76, -45, 45), new Point3D(-46, -75, 45), new Point3D(-74, -73, 41)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
        );
        scene.lights.add( //
    ...
    public void sphereTriangleInitial4() {
        ...
        scene.lights.add( //
                new SpotLight(new Color(400, 240, 0), new Point3D(-74, -74, -65), new Vector(1, 1, -3)) //
                        .setKl(1E-5).setKq(1.5E-7));
