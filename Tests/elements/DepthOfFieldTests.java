...
//                            .setMaterial(new Material().setKd(1).setKs(1).setShininess(20).setKt(0.7).setKr(0.7)),
                ...
                new Sphere(25, new Point3D(-140, -2, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKr(0.5)), //

                new Sphere(35, new Point3D(-70, 8, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(0.5)), //

                new Sphere(45, new Point3D(20, 15, 20/*-50, 20, 45ָָָ*/)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(0.5)), //

                new Sphere(60, new Point3D(180, 48, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(0.5)), //


                new Sphere(19, new Point3D(-140, -45, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(27, new Point3D(-70, -57, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(34, new Point3D(20, -61, 20/*-50, 20, 45ָָָ*/)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(45, new Point3D(180, -46, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)),


                new Sphere(12, new Point3D(-140, -75, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(18, new Point3D(-70, -97, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(22, new Point3D(20, -111, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1)), //

                new Sphere(30, new Point3D(180, -116, 20)) //
                        .setEmission(new Color(20, 0, 0)) //
                        .setMaterial(new Material().setKd(0.3).setKs(0.7).setShininess(100).setKt(1))
